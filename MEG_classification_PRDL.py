...
def grid_search(
    ...
    for learning_rate in learning_rates:
        for parameters in param_combinations:
            _, _, _, _, max_index, current_accuracy, _ = train_model(
                model_type,
                train_dataloader,
                val_dataloader,
                parameters,
    ...
    return best_accuracy, best_parameters, best_learning_rate, best_epoch
...
best_accuracy_clstm_cross, best_parameters_clstm_cross, best_learning_rate_clstm_cross, best_epoch_clstm_cross = grid_search(
    model_type='CLSTM',
...
best_accuracy_crnn_cross, best_parameters_crnn_cross, best_learning_rate_crnn_cross, best_epoch_crnn_cross = grid_search(
    model_type='CRNN',
    train_dataloader=train_dataloader_2D_cross,
    val_dataloader=val_dataloader_2D_cross,
    param_grid=param_grid_clstm,
...
best_accuracy_rnn_cross, best_parameters_rnn_cross, best_learning_rate_rnn_cross, best_epoch_rnn_cross = grid_search(
    model_type='RNN',
...
'''
===============CLSTM=================
The ultimate model has an accuracy of:  0.8541666666666667
Using the following parameters:  {'num_filters': 1, 'kernel_size': 3, 'hidden_size': 128}
And the following learning rate:  0.001
At epoch:  28
===============CRNN==================
The ultimate model has an accuracy of:  0.7708333333333334
Using the following parameters:  {'num_filters': 2, 'kernel_size': 5, 'hidden_size': 256}
And the following learning rate:  0.001
At epoch:  13
================RNN==================
The ultimate model has an accuracy of:  0.7500000000000001
Using the following parameters:  {'hidden_size': 256}
And the following learning rate:  0.001
At epoch:  5
=====================================

'''
train_losses_clstm_cross, val_losses_clstm_cross, train_accuracies_clstm_cross, val_accuracies_clstm_cross, _, _, _ = train_model(
    model_type='CLSTM',
    train_dataloader=train_dataloader_2D_cross,
    val_dataloader=val_dataloader_2D_cross,
    parameters=best_parameters_clstm_cross,
    learning_rate=0.001,
    epochs=best_epoch_clstm_cross
    )
...
train_losses_crnn_cross, val_losses_crnn_cross, train_accuracies_crnn_cross, val_accuracies_crnn_cross, _, _, _ = train_model(
    model_type='CRNN',
    train_dataloader=train_dataloader_2D_cross,
    val_dataloader=val_dataloader_2D_cross,
    parameters=best_parameters_crnn_cross,
    learning_rate=0.001,
    epochs=best_epoch_crnn_cross
    )

plot_graphs(
    train_losses_crnn_cross,
    val_losses_crnn_cross,
    train_accuracies_crnn_cross,
    val_accuracies_crnn_cross
            )

train_losses_rnn_cross, val_losses_rnn_cross, train_accuracies_rnn_cross, val_accuracies_rnn_cross, _, _, _ = train_model(
    model_type='RNN',
    train_dataloader=train_dataloader_cross,
    val_dataloader=val_dataloader_cross,
    parameters=best_parameters_rnn_cross,
    learning_rate=0.001,
    epochs=best_epoch_rnn_cross
    )

plot_graphs(
    train_losses_rnn_cross,
    val_losses_rnn_cross,
    train_accuracies_rnn_cross,
    val_accuracies_rnn_cross
            )
...
best_accuracy_clstm_intra, best_parameters_clstm_intra, best_learning_rate_clstm_intra, best_epoch_clstm_intra = grid_search(
    model_type='CLSTM',
...
best_accuracy_crnn_intra, best_parameters_crnn_intra, best_learning_rate_crnn_intra, best_epoch_crnn_intra = grid_search(
    model_type='CRNN',
    train_dataloader=train_dataloader_2D_intra,
    val_dataloader=val_dataloader_2D_intra,
    param_grid=param_grid_clstm,
...
best_accuracy_rnn_intra, best_parameters_rnn_intra, best_learning_rate_rnn_intra, best_epoch_rnn_intra = grid_search(
    model_type='RNN',
...
Using the following parameters:  {'num_filters': 1, 'kernel_size': 3, 'hidden_size': 64}
And the following learning rate:  0.001
At epoch:  2
===============CRNN==================
The ultimate model has an accuracy of:  1.0
...
'''
train_losses_clstm_intra, val_losses_clstm_intra, train_accuracies_clstm_intra, val_accuracies_clstm_intra, _, _, _ = train_model(
    model_type='CLSTM',
    train_dataloader=train_dataloader_2D_intra,
    val_dataloader=val_dataloader_2D_intra,
    parameters=best_parameters_clstm_intra,
    learning_rate=0.001,
    epochs=best_epoch_clstm_intra
    )

plot_graphs(
    train_losses_clstm_intra,
    val_losses_clstm_intra,
    train_accuracies_clstm_intra,
    val_accuracies_clstm_intra
            )

train_losses_crnn_intra, val_losses_crnn_intra, train_accuracies_crnn_intra, val_accuracies_crnn_intra, _, _, _ = train_model(
    model_type='CRNN',
    train_dataloader=train_dataloader_2D_intra,
    val_dataloader=val_dataloader_2D_intra,
    parameters=best_parameters_crnn_intra,
    learning_rate=0.001,
    epochs=best_epoch_crnn_intra
    )

plot_graphs(
    train_losses_crnn_intra,
    val_losses_crnn_intra,
    train_accuracies_crnn_intra,
    val_accuracies_crnn_intra
            )

train_losses_rnn_intra, val_losses_rnn_intra, train_accuracies_rnn_intra, val_accuracies_rnn_intra, _, _, _ = train_model(
    model_type='RNN',
    train_dataloader=train_dataloader_intra,
    val_dataloader=val_dataloader_intra,
    parameters=best_parameters_rnn_intra,
    learning_rate=0.001,
    epochs=best_epoch_rnn_intra
    )

plot_graphs(
    train_losses_rnn_intra,
    val_losses_rnn_intra,
    train_accuracies_rnn_intra,
    val_accuracies_rnn_intra
            )
